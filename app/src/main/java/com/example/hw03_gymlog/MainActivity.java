...
public class MainActivity extends AppCompatActivity {
    ...
    com.example.hw03_gymlog.databinding.ActivityMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = com.example.hw03_gymlog.databinding.ActivityMainBinding.inflate(getLayoutInflater());
    ...
    private void updateDisplay() {
        ...
        Log.d(TAG, "currentInfo: " + currentInfo);
